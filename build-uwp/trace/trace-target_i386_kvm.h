...
#line 4 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_x86_fixup_msi_error " "VT-d failed to remap interrupt for GSI %" PRIu32 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , gsi);
#line 40 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        } else {
#line 4 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("kvm_x86_fixup_msi_error " "VT-d failed to remap interrupt for GSI %" PRIu32 "\n", gsi);
#line 44 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        }
    }
}
...
static inline void _nocheck__trace_kvm_x86_add_msi_route(int virq)
{
    if (trace_event_get_state(TRACE_KVM_X86_ADD_MSI_ROUTE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_x86_add_msi_route " "Adding route entry for virq %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , virq);
#line 71 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        } else {
#line 5 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("kvm_x86_add_msi_route " "Adding route entry for virq %d" "\n", virq);
#line 75 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        }
    }
}
...
static inline void _nocheck__trace_kvm_x86_remove_msi_route(int virq)
{
    if (trace_event_get_state(TRACE_KVM_X86_REMOVE_MSI_ROUTE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 6 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_x86_remove_msi_route " "Removing route entry for virq %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , virq);
#line 102 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        } else {
#line 6 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("kvm_x86_remove_msi_route " "Removing route entry for virq %d" "\n", virq);
#line 106 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        }
    }
}
...
static inline void _nocheck__trace_kvm_x86_update_msi_routes(int num)
{
    if (trace_event_get_state(TRACE_KVM_X86_UPDATE_MSI_ROUTES) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 7 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_x86_update_msi_routes " "Updated %d MSI routes" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , num);
#line 133 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        } else {
#line 7 "C:/Users/seski/source/repos/xemu-uwp/target/i386/kvm/trace-events"
            qemu_log("kvm_x86_update_msi_routes " "Updated %d MSI routes" "\n", num);
#line 137 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_i386_kvm.h"
        }
    }
}
