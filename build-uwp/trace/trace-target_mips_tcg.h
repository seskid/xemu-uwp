...
#line 4 "C:/Users/seski/source/repos/xemu-uwp/target/mips/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:mips_translate_c0 " "%s %s (reg %d sel %d)" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , instr, rn, reg, sel);
#line 34 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_mips_tcg.h"
        } else {
#line 4 "C:/Users/seski/source/repos/xemu-uwp/target/mips/tcg/trace-events"
            qemu_log("mips_translate_c0 " "%s %s (reg %d sel %d)" "\n", instr, rn, reg, sel);
#line 38 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_mips_tcg.h"
        }
    }
}
...
static inline void _nocheck__trace_mips_translate_tr(const char * instr, int rt, int u, int sel, int h)
{
    if (trace_event_get_state(TRACE_MIPS_TRANSLATE_TR) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "C:/Users/seski/source/repos/xemu-uwp/target/mips/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:mips_translate_tr " "%s (reg %d u %d sel %d h %d)" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , instr, rt, u, sel, h);
#line 65 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_mips_tcg.h"
        } else {
#line 5 "C:/Users/seski/source/repos/xemu-uwp/target/mips/tcg/trace-events"
            qemu_log("mips_translate_tr " "%s (reg %d u %d sel %d h %d)" "\n", instr, rt, u, sel, h);
#line 69 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-target_mips_tcg.h"
        }
    }
}
