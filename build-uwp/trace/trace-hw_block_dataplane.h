...
#line 4 "C:/Users/seski/source/repos/xemu-uwp/hw/block/dataplane/trace-events"
            qemu_log("%d@%zu.%06zu:virtio_blk_data_plane_start " "dataplane %p" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , s);
#line 34 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_block_dataplane.h"
        } else {
#line 4 "C:/Users/seski/source/repos/xemu-uwp/hw/block/dataplane/trace-events"
            qemu_log("virtio_blk_data_plane_start " "dataplane %p" "\n", s);
#line 38 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_block_dataplane.h"
        }
    }
}
...
static inline void _nocheck__trace_virtio_blk_data_plane_stop(void * s)
{
    if (trace_event_get_state(TRACE_VIRTIO_BLK_DATA_PLANE_STOP) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "C:/Users/seski/source/repos/xemu-uwp/hw/block/dataplane/trace-events"
            qemu_log("%d@%zu.%06zu:virtio_blk_data_plane_stop " "dataplane %p" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , s);
#line 65 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_block_dataplane.h"
        } else {
#line 5 "C:/Users/seski/source/repos/xemu-uwp/hw/block/dataplane/trace-events"
            qemu_log("virtio_blk_data_plane_stop " "dataplane %p" "\n", s);
#line 69 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_block_dataplane.h"
        }
    }
}
