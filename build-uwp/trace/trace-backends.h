...
#line 4 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("%d@%zu.%06zu:dbus_vmstate_pre_save "  "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     );
#line 40 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        } else {
#line 4 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("dbus_vmstate_pre_save "  "\n");
#line 44 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        }
    }
}
...
static inline void _nocheck__trace_dbus_vmstate_post_load(int version_id)
{
    if (trace_event_get_state(TRACE_DBUS_VMSTATE_POST_LOAD) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("%d@%zu.%06zu:dbus_vmstate_post_load " "version_id: %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , version_id);
#line 71 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        } else {
#line 5 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("dbus_vmstate_post_load " "version_id: %d" "\n", version_id);
#line 75 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        }
    }
}
...
static inline void _nocheck__trace_dbus_vmstate_loading(const char * id)
{
    if (trace_event_get_state(TRACE_DBUS_VMSTATE_LOADING) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 6 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("%d@%zu.%06zu:dbus_vmstate_loading " "id: %s" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id);
#line 102 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        } else {
#line 6 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("dbus_vmstate_loading " "id: %s" "\n", id);
#line 106 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        }
    }
}
...
static inline void _nocheck__trace_dbus_vmstate_saving(const char * id)
{
    if (trace_event_get_state(TRACE_DBUS_VMSTATE_SAVING) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 7 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("%d@%zu.%06zu:dbus_vmstate_saving " "id: %s" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id);
#line 133 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        } else {
#line 7 "C:/Users/seski/source/repos/xemu-uwp/backends/trace-events"
            qemu_log("dbus_vmstate_saving " "id: %s" "\n", id);
#line 137 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-backends.h"
        }
    }
}
