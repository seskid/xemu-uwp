...
#line 4 "C:/Users/seski/source/repos/xemu-uwp/scsi/trace-events"
            qemu_log("%d@%zu.%06zu:pr_manager_execute " "fd=%d cmd=0x%02x service action=0x%02x" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , fd, cmd, sa);
#line 34 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-scsi.h"
        } else {
#line 4 "C:/Users/seski/source/repos/xemu-uwp/scsi/trace-events"
            qemu_log("pr_manager_execute " "fd=%d cmd=0x%02x service action=0x%02x" "\n", fd, cmd, sa);
#line 38 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-scsi.h"
        }
    }
}
...
static inline void _nocheck__trace_pr_manager_run(int fd, int cmd, int sa)
{
    if (trace_event_get_state(TRACE_PR_MANAGER_RUN) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "C:/Users/seski/source/repos/xemu-uwp/scsi/trace-events"
            qemu_log("%d@%zu.%06zu:pr_manager_run " "fd=%d cmd=0x%02x service action=0x%02x" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , fd, cmd, sa);
#line 65 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-scsi.h"
        } else {
#line 5 "C:/Users/seski/source/repos/xemu-uwp/scsi/trace-events"
            qemu_log("pr_manager_run " "fd=%d cmd=0x%02x service action=0x%02x" "\n", fd, cmd, sa);
#line 69 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-scsi.h"
        }
    }
}
