...
#line 4 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("%d@%zu.%06zu:mhp_pc_dimm_assigned_slot " "%d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , slot);
#line 40 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        } else {
#line 4 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("mhp_pc_dimm_assigned_slot " "%d" "\n", slot);
#line 44 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        }
    }
}
...
static inline void _nocheck__trace_memory_device_pre_plug(const char * id, uint64_t addr)
{
    if (trace_event_get_state(TRACE_MEMORY_DEVICE_PRE_PLUG) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 6 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("%d@%zu.%06zu:memory_device_pre_plug " "id=%s addr=0x%"PRIx64 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id, addr);
#line 71 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        } else {
#line 6 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("memory_device_pre_plug " "id=%s addr=0x%"PRIx64 "\n", id, addr);
#line 75 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        }
    }
}
...
static inline void _nocheck__trace_memory_device_plug(const char * id, uint64_t addr)
{
    if (trace_event_get_state(TRACE_MEMORY_DEVICE_PLUG) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 7 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("%d@%zu.%06zu:memory_device_plug " "id=%s addr=0x%"PRIx64 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id, addr);
#line 102 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        } else {
#line 7 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("memory_device_plug " "id=%s addr=0x%"PRIx64 "\n", id, addr);
#line 106 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        }
    }
}
...
static inline void _nocheck__trace_memory_device_unplug(const char * id, uint64_t addr)
{
    if (trace_event_get_state(TRACE_MEMORY_DEVICE_UNPLUG) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 8 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("%d@%zu.%06zu:memory_device_unplug " "id=%s addr=0x%"PRIx64 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id, addr);
#line 133 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        } else {
#line 8 "C:/Users/seski/source/repos/xemu-uwp/hw/mem/trace-events"
            qemu_log("memory_device_unplug " "id=%s addr=0x%"PRIx64 "\n", id, addr);
#line 137 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-hw_mem.h"
        }
    }
}
