...
#line 5 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:exec_tb " "tb:%p pc=0x%"PRIxPTR "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , tb, pc);
#line 40 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        } else {
#line 5 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("exec_tb " "tb:%p pc=0x%"PRIxPTR "\n", tb, pc);
#line 44 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        }
    }
}
...
static inline void _nocheck__trace_exec_tb_nocache(void * tb, uintptr_t pc)
{
    if (trace_event_get_state(TRACE_EXEC_TB_NOCACHE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 6 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:exec_tb_nocache " "tb:%p pc=0x%"PRIxPTR "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , tb, pc);
#line 71 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        } else {
#line 6 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("exec_tb_nocache " "tb:%p pc=0x%"PRIxPTR "\n", tb, pc);
#line 75 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        }
    }
}
...
static inline void _nocheck__trace_exec_tb_exit(void * last_tb, unsigned int flags)
{
    if (trace_event_get_state(TRACE_EXEC_TB_EXIT) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 7 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:exec_tb_exit " "tb:%p flags=0x%x" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , last_tb, flags);
#line 102 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        } else {
#line 7 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("exec_tb_exit " "tb:%p flags=0x%x" "\n", last_tb, flags);
#line 106 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        }
    }
}
...
static inline void _nocheck__trace_translate_block(void * tb, uintptr_t pc, const void * tb_code)
{
    if (trace_event_get_state(TRACE_TRANSLATE_BLOCK) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 10 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("%d@%zu.%06zu:translate_block " "tb:%p, pc:0x%"PRIxPTR", tb_code:%p" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , tb, pc, tb_code);
#line 133 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        } else {
#line 10 "C:/Users/seski/source/repos/xemu-uwp/accel/tcg/trace-events"
            qemu_log("translate_block " "tb:%p, pc:0x%"PRIxPTR", tb_code:%p" "\n", tb, pc, tb_code);
#line 137 "C:/Users/seski/source/repos/xemu-uwp/build/trace/trace-accel_tcg.h"
        }
    }
}
